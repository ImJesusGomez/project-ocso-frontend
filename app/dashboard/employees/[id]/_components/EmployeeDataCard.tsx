...
export default function EmployeeDataCard({ employee }: { employee: Employee }) {
  return (
    <div className="flex flex-row items-center gap-2 bg-white rounded-md grow-0 h-fit px-4 py-2 m-2 border-2 border-orange-400">
      <div className="text-xl">
        ...
        <Link
          className="underline"
          href={{ pathname: `/dashboard/locations/${employee.location?.locationId}` }}
        >
